 ...
 */
@Description(name = "cosine_distance", value = "_FUNC_(ftvec1, ftvec2) - Returns a cosine distance of the given two vectors")
@UDFType(deterministic = true, stateful = false)
public final class CosineDistanceUDF extends UDF {
