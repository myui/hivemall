...
@Description(name = "quantify", value = "_FUNC_(col1, col2, ...) - Returns an identified features")
public final class QuantifyColumnsUDTF extends GenericUDTF {
    ...
    public StructObjectInspector initialize(ObjectInspector[] argOIs) throws UDFArgumentException {
        ...
        this.forwardObjs = new Object[size];
        this.forwardIntObjs = new IntWritable[size];
