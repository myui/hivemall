...
public class MapModelTest {
    ...
    public void testClassification() throws HiveException {
        ...
        ObjectInspector paramOI = ObjectInspectorUtils.getConstantObjectInspector(PrimitiveObjectInspectorFactory.javaStringObjectInspector, "-factor 20 -classification -seed 31 -iters 100");
