...
public final class MetricsRegistry {
    ...
    public static void registerMBeans(@Nonnull MixServerMetrics metrics, int port) {
        ...
        final ObjectName name = makeMBeanName(
                "hivemall", MixServerMetricsMBean.class.getSimpleName(), "port=" + port);
        try {
    ...
    private static ObjectName makeMBeanName(
    ...
    private static String makeMBeanNameString(
            @Nonnull final String domain,
            @Nonnull final String type,
            @Nonnull final String channelName) {
