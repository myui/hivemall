...
/**
 * ADAM algorithm with element-wise adaptive learning rates.
 */
public final class NewAdamUDTF extends RegressionBaseUDTF {

    @Override
    public StructObjectInspector initialize(ObjectInspector[] argOIs) throws UDFArgumentException {
        final int numArgs = argOIs.length;
        if(numArgs != 2 && numArgs != 3) {
            throw new UDFArgumentException("NewAdamDTF takes 2 or 3 arguments: List<Text|Int|BitInt> features, float target [, constant string options]");
        }
    ...
    // TODO: Need to add options for `Solver.AdamSolver`
