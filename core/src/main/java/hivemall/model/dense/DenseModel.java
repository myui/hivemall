...
public final class DenseModel extends AbstractPredictionModel {
    ...
    public <T extends IWeightValue> T get(Object feature) {
        ...
        if(sum_of_squared_gradients != null) {
            if(sum_of_squared_delta_x != null) {
                return (T) new WeightValue.WeightValueParamsF2(weights[i], sum_of_squared_gradients[i], sum_of_squared_delta_x[i]);
            } else if(sum_of_gradients != null) {
                return (T) new WeightValue.WeightValueParamsF2(weights[i], sum_of_squared_gradients[i], sum_of_gradients[i]);
            } else {
                return (T) new WeightValue.WeightValueParamsF1(weights[i], sum_of_squared_gradients[i]);
            }
        } else if(covars != null) {
            return (T) new WeightValue.WeightValueWithCovar(weights[i], covars[i]);
        } else {
