...
public class Base64InputStream extends FilterInputStream {
     ...
     * @param flags bit flags for controlling the decoder; see the constants in {@link Base64}
     */
    ...
    /**
     * Read data from the input stream into inputBuffer, then decode/encode it into the empty
     * coder.output, and reset the outputStart and outputEnd pointers.
     */
