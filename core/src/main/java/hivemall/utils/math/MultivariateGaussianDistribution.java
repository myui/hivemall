 ...
 * @author Haifeng Li
 */
public class MultivariateGaussianDistribution extends AbstractMultivariateDistribution implements
    ...
    /**
     * Constructor. The distribution will have a diagonal covariance matrix. Each element has
     * different variance.
     *
     * @param mean mean vector.
    ...
    public MultivariateGaussianDistribution(double[] mean, double[] var) {
        if (mean.length != var.length) {
            throw new IllegalArgumentException(
                "Mean vector and covariance matrix have different dimension");
        }
    ...
    /**
     * Algorithm from Alan Genz (1992) Numerical Computation of Multivariate Normal Probabilities,
     * Journal of Computational and Graphical Statistics, pp. 141-149.
     *
     * The difference between returned value and the true value of the CDF is less than 0.001 in
     * 99.9% time. The maximum number of iterations is set to 10000.
     */
    @Override
