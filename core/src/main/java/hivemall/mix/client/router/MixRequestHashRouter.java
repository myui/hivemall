...
public final class MixRequestHashRouter extends MixRequestRouter {

    public MixRequestHashRouter(@CheckForNull String connectInfo) {
        super(connectInfo);
    }

    @Override
    public NodeInfo selectNode(@Nonnull MixMessage msg) throws MixException {
