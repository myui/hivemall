...
public class FFMPredictionModelTest {
    ...
    public void testSerialize() throws IOException, ClassNotFoundException {
        IntOpenHashTable<Entry> map = new IntOpenHashTable<FieldAwareFactorizationMachineModel.Entry>(100);
        map.put(1, new Entry(1, new float[] {1f}));
        map.put(2, new Entry(2, new float[] {1f, 2f}));
        map.put(3, new Entry(3, new float[] {1f, 2f, 3f}));
        FFMPredictionModel expected = new FFMPredictionModel(map, 0, 10,
        ...
        Assert.assertEquals(10, actual.getNumFactors());
